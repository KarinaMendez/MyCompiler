...
//ready
field_decl: (INT | BOO | VOD) ((ID | (ID BRAKET int_literal BRAKET2)) COMA*)+ SEMICOLON 							#fieldDec1; 


//ready
method_decl: (INT | BOO | VOD) ID PARENTESIS (cual ID  (COMA cual ID)*)* PARENTESIS2 block 							# methodDec;
